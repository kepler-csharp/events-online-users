...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    {{--  <link href="https://cdn.jsdelivr.net/gh/kepler-csharp/events-online-users@main/public/css/paymentEvent.css" rel="stylesheet"> --}}
                ...
                <form action="{{ route('payment.process', $showtime['id']) }}" method="POST" class="payment-form">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full">
                            ...
                            <input type="text" class="custom-input" placeholder="Nombre completo"
